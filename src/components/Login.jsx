...
const Login = () => {
    ...
    return (
        <div className="relative min-h-screen bg-[#050b14] flex items-center justify-center overflow-hidden font-sans">
            ...
            {/* Circuit Background Graphic - positioned on the left side conceptually */}
            <div className="absolute left-0 top-0 w-full lg:w-[60%] h-full pointer-events-none z-0 opacity-40 sm:opacity-60 overflow-hidden">
                ...
                {/* Background decorative AI chip floating on the left */}
                <motion.div
                ...
                >
                    <div className="absolute inset-0 border-2 border-dashed border-cyan-500/20 rounded-3xl animate-[spin_20s_linear_infinite]" />
                    <FiCpu className="text-6xl text-cyan-500/50 drop-shadow-[0_0_15px_rgba(6,182,212,0.5)]" />
                </motion.div>
            </div>
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
                    ...
                    <div className="hidden lg:flex flex-col flex-1 text-left">
                        ...
                        >
                            Log in to your <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 drop-shadow-md">AI Workspace</span>
                        </motion.h1>
                        ...
                        >
                            Reconnect with your personalized career path, resume analysis, and skill recommendations powered by deep learning.
                        </motion.p>
                    </div>
                    ...
                    >
                        ...
                        <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                            ...
                            <button
                                ...
                                className="mt-6 w-full flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 text-white py-3.5 rounded-xl font-medium transition-all active:scale-95 disabled:opacity-70"
                            >
